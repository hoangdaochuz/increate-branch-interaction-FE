...
export const productApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getProducts: builder.query<IProduct[], void>({
      ...
      transformResponse: (response: { data: { products: IProduct[] } }) => response.data.products,
    }),
    ...
    getProduct: builder.query<IProduct, string>({
      ...
      transformResponse: (response: { data: { product: IProduct } }, _args, _meta) => response.data.product,
